parasails.registerPage('sliderlist', {
  //  ╦╔╗╔╦╔╦╗╦╔═╗╦    ╔═╗╔╦╗╔═╗╔╦╗╔═╗
  //  ║║║║║ ║ ║╠═╣║    ╚═╗ ║ ╠═╣ ║ ║╣
  //  ╩╝╚╝╩ ╩ ╩╩ ╩╩═╝  ╚═╝ ╩ ╩ ╩ ╩ ╚═╝
  data: {
    //…
    itemView: '/slider/sliderlist/',
    syncing: false,
    cloudError: '',
    formErrors: {},

    listView: '/slider/sliderlist',
    itemView: '/slider/slider/',
    removeAction: 'removeslider',
  ...
  beforeMount: function() {
    ...
    this.formData.slider_name = this.filter.slider_name ? this.filter.slider_name : '';
